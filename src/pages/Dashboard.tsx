        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              {/* Recent Articles */}
              <div className="lg:col-span-2 bg-dashboard-card rounded-2xl border border-dashboard-border p-4 sm:p-6">
                ...
                <div className="space-y-2 sm:space-y-3">
                  {recentArticles.length === 0 ? (
                    <div className="text-center py-8 sm:py-12 text-muted-foreground">
                      <div className="h-12 w-12 sm:h-14 sm:w-14 rounded-2xl bg-dashboard-bg flex items-center justify-center mx-auto mb-3">
                        <FileText className="h-6 w-6 sm:h-7 sm:w-7 opacity-50" />
                      </div>
                      <p className="font-medium text-sm sm:text-base">No articles yet</p>
                      <p className="text-xs sm:text-sm mt-1">Create your first article to get started</p>
                    </div>
                  ) : (
                    recentArticles.map((article, index) => (
                      <div
                        key={article.id}
                        className="flex items-center justify-between p-3 sm:p-4 rounded-xl hover:bg-dashboard-bg transition-all group"
                        style={{ animationDelay: `${index * 50}ms` }}
                      >
                        <div className="flex-1 min-w-0 mr-3">
                          <h4 className="font-medium text-sm sm:text-base truncate group-hover:text-dashboard-accent transition-colors">
                            {article.title}
                          </h4>
                        ...
                        <span
                          className={`text-xs px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg font-semibold whitespace-nowrap ${
                            article.published
